...
with open(os.path.join("saved_data", "best_rf_params.json"), "r", encoding="utf-8") as file_rf:
    best_rf_params = json.load(file_rf)

with open(os.path.join("saved_data", "best_xgb_params.json"), "r", encoding="utf-8") as file_xgb:
