...
plt.savefig("plots/SEM_ROC_Curve_ca.png", dpi=300)
plt.close()
...
plt.title("Stacked Ensemble Model RGE Curve (California)")
plt.legend()
plt.grid(True)
plt.savefig("plots/SEM_RGE_ca.png", dpi=300)
plt.close()
...
plt.title('Stacked Ensemble Model RGR Curve (California)')
...
plt.xlim([0, 1])
plt.grid(True)
plt.savefig("plots/SEM_RGR_ca.png", dpi=300)
plt.close()
