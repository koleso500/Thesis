...
best_model = joblib.load("../saved_models/best_xgb_model_ca.joblib")
x_train = pd.read_csv("../saved_data/x_train_xgb_ca.csv")
x_test = pd.read_csv("../saved_data/x_test_xgb_ca.csv")
y_train = pd.read_csv("../saved_data/y_train_xgb_ca.csv")
y_test = pd.read_csv("../saved_data/y_test_xgb_ca.csv")
...
plt.savefig("plots/XGB_ROC_Curve_ca.png", dpi=300)
plt.close()
...
plt.savefig("plots/XGB_Importance_ca.png", dpi=300)
plt.close()
...
plt.ylabel("RGE")
plt.title("XGBoost RGE Curve (California)")
plt.legend()
plt.grid(True)
plt.savefig("plots/XGB_RGE_ca.png", dpi=300)
plt.close()
...
plt.title('XGBoost RGR Curve (California)')
...
plt.xlim([0, 1])
plt.grid(True)
plt.savefig("plots/XGB_RGR_ca.png", dpi=300)
plt.close()
...
file_path = os.path.join("../saved_data", "final_results_xgb_ca.json")
