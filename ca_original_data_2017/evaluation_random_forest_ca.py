...
plt.savefig("plots/RF_ROC_Curve_ca.png", dpi=300)
plt.close()
...
plt.ylabel("RGE")
plt.title("Random Forest RGE Curve (California)")
plt.legend()
plt.grid(True)
plt.savefig("plots/RF_RGE_ca.png", dpi=300)
plt.close()
...
plt.title('Random Forest RGR Curve (California)')
...
plt.xlim([0, 1])
plt.grid(True)
plt.savefig("plots/RF_RGR_ca.png", dpi=300)
plt.close()
...
file_path = os.path.join("../saved_data", "final_results_rf_ca.json")
