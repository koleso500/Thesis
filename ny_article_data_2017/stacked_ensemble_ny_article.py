...
plt.ylabel("RGE")
plt.title("Stacked Ensemble Model RGE Curve (New York Article)")
plt.legend()
plt.grid(True)
plt.savefig("plots/SEM_RGE_ny_article.png", dpi=300)
plt.close()
...
plt.title('Stacked Ensemble Model RGR Curve (New York Article)')
...
plt.xlim([0, 1])
plt.grid(True)
plt.savefig("plots/SEM_RGR_ny_article.png", dpi=300)
plt.close()
