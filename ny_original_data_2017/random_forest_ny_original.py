...
# Save the splits
x_train.to_csv(os.path.join("../saved_data", "x_train_rf_ny_original.csv"), index=False)
x_test.to_csv(os.path.join("../saved_data", "x_test_rf_ny_original.csv"), index=False)
