...
plt.ylabel("RGE")
plt.title("Random Classifier RGE Curve (New York Original)")
plt.legend()
plt.grid(True)
plt.savefig("plots/Random_RGE_ny_original.png", dpi=300)
plt.close()
...
plt.title('Random Classifier RGR Curve (New York Original)')
plt.xlabel('Normalized Perturbation')
plt.ylabel('RGR')
plt.legend()
plt.xlim([0, 1])
plt.grid(True)
plt.savefig("plots/Random_RGR_ny_original.png", dpi=300)
plt.close()
