...
# Explainability
print(compute_rge_values(x_train_scaled, x_test_scaled, y_prob, log_model, list(x_test_scaled.columns), group=True))

# Fairness
print(compute_rga_parity(x_train_scaled, x_test_scaled, y_test, y_prob, log_model, "applicant_race_1"))
print(compute_rga_parity(x_train_scaled, x_test_scaled, y_test, y_prob, log_model, "applicant_sex_name"))
